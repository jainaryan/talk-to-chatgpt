...
__all__ = [
    ...
    'DISPID_SOTsCount', 'DISPID_SpeechBaseStream',
    'ISpeechRecoResultTimes',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPIDSPRG',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPSHORTCUTTYPE',
    'DISPID_SVAlertBoundary', 'SPPHRASEELEMENT', 'DISPID_SPCLangId',
    'SPSHT_EMAIL', 'SRSInactiveWithPurge',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SRCState',
    'SP_VISEME_9', 'DISPID_SGRs_NewEnum', 'SVP_12', 'SLTUser',
    'SPEI_START_INPUT_STREAM', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SPPParent', 'SPFILEMODE', 'DISPID_SPACommit', 'SVP_11',
    'SSFMOpenForRead', 'SpeechStreamFileMode',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SMSALineId', 'SDTRule',
    'SpeechAudioVolume', 'SRTSMLTimeout', 'DISPID_SGRsFindRule',
    'DISPID_SLPSymbolic', 'ISpDataKey', 'SpeechLoadOption',
    'DISPID_SGRAddState', 'DISPID_SpeechMemoryStream', 'ISpEventSink',
    'SPEI_MAX_SR', 'SRSActiveAlways', 'SpeechFormatType',
    'ISpRecognizer2', 'DISPID_SRCERecognizerStateChange',
    'eLEXTYPE_PRIVATE2', 'ISpeechLexiconPronunciation', 'tagSTATSTG',
    'SBONone', 'ISpRecoGrammar', 'SAFT48kHz16BitStereo',
    'SPEI_INTERFERENCE', 'SpShortcut', 'DISPID_SPRNumberOfElements',
    'DISPID_SWFEChannels', 'SpObjectTokenCategory',
    'IInternetSecurityMgrSite', 'SpeechStreamSeekPositionType',
    'ISpeechRecognizer', 'ISpeechPhraseAlternate',
    'SpNotifyTranslator', 'SAFT16kHz16BitStereo',
    'DISPID_SpeechPhraseReplacement', 'SpeechAddRemoveWord',
    'SpPhraseInfoBuilder', 'SP_VISEME_6', 'SP_VISEME_21',
    'DISPID_SpeechDataKey', 'ISpMMSysAudio', 'DISPID_SOTRemove',
    'DISPID_SGRSTPropertyValue', 'ISpeechXMLRecoResult', 'ISpVoice',
    'STCAll', 'SAFTDefault', 'DISPID_SpeechObjectTokenCategory',
    'SpeechVoiceEvents', 'SpeechVoiceSkipTypeSentence',
    'SAFTCCITT_uLaw_8kHzStereo', 'SSSPTRelativeToEnd',
    'SpeechVisemeFeature', 'SPSNoun', 'ISpeechPhraseProperties',
    'eWORDTYPE_ADDED', 'DISPID_SpeechWaveFormatEx',
    'SPWORDPRONOUNCEABLE', 'DISPID_SDKOpenKey',
    'DISPID_SpeechObjectTokens',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'DISPID_SRGId',
    'SPSMF_SAPI_PROPERTIES', 'SINone', 'SAFT16kHz8BitMono',
    'DISPID_SRRecognizer', 'DISPID_SVIsUISupported',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SOTCEnumerateTokens',
    'DISPID_SpeechLexiconWord', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SOTCSetId', 'DISPID_SGRSAddWordTransition',
    'SpeechTokenShellFolder', 'DISPID_SDKGetlongValue',
    'DISPID_SpeechAudio', 'SPEI_MIN_TTS', 'SPINTERFERENCE_NONE',
    'SRESoundEnd', 'DISPID_SVEVoiceChange', 'SDA_One_Trailing_Space',
    'SpeechDictationTopicSpelling', 'DISPID_SRCEHypothesis',
    'DISPID_SpeechRecognizerStatus', 'ISpPhraseAlt',
    'DISPID_SpeechVoiceEvent', 'SAFTADPCM_22kHzStereo',
    'DISPID_SLWWord', 'SpeechVoicePriority', 'SAFT48kHz16BitMono',
    'SVEViseme', 'SpeechTokenKeyFiles', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SLPPartOfSpeech', 'SPEI_SR_PRIVATE', 'DISPID_SPPChildren',
    'eLEXTYPE_PRIVATE9', 'DISPID_SRCPause', 'SGRSTTDictation',
    'SPFM_OPEN_READONLY', 'DISPID_SLPPhoneIds',
    'SAFT32kHz16BitStereo', 'SPSVerb', 'SGDSActiveWithAutoPause',
    'SpeechUserTraining', 'SPLO_DYNAMIC', 'SAFTCCITT_uLaw_8kHzMono',
    'SpMMAudioOut', 'SpStream', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SBSWrite', 'DISPID_SPIAudioStreamPosition',
    'SGLexicalNoSpecialChars', 'SECNormalConfidence', 'SVEPrivate',
    'SPBO_PAUSE', 'DISPID_SRCERecognition', 'DISPID_SRCEBookmark',
    'SPPHRASE', 'SPBO_TIME_UNITS', 'SGPronounciation',
    'SpeechRuleState', 'SASRun', 'DISPID_SVSLastResult',
    'ISpeechGrammarRule', 'SAFT8kHz16BitStereo', 'SAFT11kHz8BitMono',
    'DISPID_SPRuleId', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SpeechVoiceSpeakFlags', 'DISPID_SVVoice',
    'SpeechCategoryAudioIn', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SPEDisplayAttributes', 'SAFTCCITT_uLaw_11kHzStereo',
    'ISpeechObjectTokenCategory', 'ISpeechVoice',
    'DISPID_SRSNumberOfActiveRules', 'SWTAdded',
    'DISPID_SABIEventBias', 'ISpeechPhraseInfoBuilder', 'SGDSActive',
    'SRTExtendableParse', 'DISPID_SPPs_NewEnum', 'SP_VISEME_14',
    'IEnumSpObjectTokens', 'SAFT16kHz8BitStereo',
    'SAFTNonStandardFormat', 'SPINTERFERENCE_NOSIGNAL',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SADefaultFormat',
    'STSF_AppData', 'SVP_6', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SRStatus', 'SPSERIALIZEDRESULT', 'SpMemoryStream',
    'DISPID_SAVolume', 'SPSTREAMFORMATTYPE', 'DISPID_SRRPhraseInfo',
    'SSSPTRelativeToCurrentPosition', 'SVEPhoneme',
    'DISPID_SpeechAudioBufferInfo', 'SVSFParseSsml', 'eLEXTYPE_APP',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SPIGetText',
    'DISPID_SGRSTType', 'SAFTCCITT_uLaw_44kHzStereo',
    'ISpeechPhraseAlternates', 'DISPID_SGRsDynamic', 'DISPID_SAFType',
    'DISPID_SDKEnumValues', 'SPEI_ADAPTATION',
    'DISPID_SRSCurrentStreamNumber', 'SVSFPersistXML',
    'ISpNotifyTranslator', 'SPEI_TTS_PRIVATE',
    'DISPID_SRCRetainedAudioFormat', 'SVP_16', 'SpeechTokenContext',
    'SP_VISEME_12', 'DISPID_SVSLastBookmarkId', 'eLEXTYPE_USER',
    'ISpeechObjectTokens', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SPRuleNumberOfElements', 'SAFT12kHz16BitStereo',
    'ISpPhoneConverter', 'DISPID_SLWLangId', 'DISPID_SGRSRule',
    'SAFT24kHz8BitMono', 'DISPID_SRRGetXMLErrorInfo',
    'eLEXTYPE_PRIVATE14', 'ISpeechMemoryStream', 'DISPID_SRCVoice',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SMSADeviceId',
    'DISPID_SAEventHandle', 'STCInprocHandler', '_SPAUDIOSTATE',
    'DISPID_SVSPhonemeId', 'SAFTCCITT_ALaw_44kHzMono',
    'SpeechAllElements', 'SINoise', 'ISpeechAudioBufferInfo',
    'ISpObjectToken', 'DISPID_SRGRules', 'SPGS_ENABLED',
    'DISPID_SpeechVoice', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SPRText',
    'DISPID_SPAStartElementInResult', 'DISPID_SPEEngineConfidence',
    'DISPID_SDKCreateKey', 'Speech_Max_Pron_Length',
    'DISPID_SpeechPhraseAlternate', 'SVP_4',
    'DISPID_SVAudioOutputStream', 'DISPID_SRDisplayUI',
    'SpeechCategoryVoices', 'ISpGrammarBuilder',
    'DISPID_SABIMinNotification', 'SAFTADPCM_44kHzMono',
    'SPRULESTATE', 'DISPID_SGRsCommitAndSave', 'ISpeechRecoGrammar',
    'DISPID_SPPEngineConfidence', 'DISPID_SPRuleFirstElement',
    'DISPID_SVSLastStreamNumberQueued', 'ISpeechPhraseElements',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SOTCDefault',
    'DISPID_SVEAudioLevel', 'DISPID_SRRTOffsetFromStart',
    'SGRSTTWord', 'DISPID_SASNonBlockingIO', 'SAFT32kHz8BitMono',
    'SVP_14', 'SLOStatic', 'SPAS_STOP', 'SAFT8kHz16BitMono',
    ...
    'SRTReSent', 'DISPID_SRCEPropertyNumberChange',
    'ISpeechObjectToken', 'SASPause', 'SECFEmulateResult',
    'SAFT44kHz16BitMono', 'SPSNotOverriden', 'SP_VISEME_20',
    'DISPID_SGRsCount', 'STCRemoteServer', 'DISPID_SpeechAudioFormat',
    'ISpResourceManager', 'SASStop', 'SPWORDLIST',
    'DISPID_SDKEnumKeys', 'SpeechVoiceCategoryTTSRate',
    'eLEXTYPE_PRIVATE6', 'SWTDeleted', 'SAFT8kHz8BitMono',
    'SPINTERFERENCE_NOISE', 'SpResourceManager', 'SVP_2',
    'SpeechVisemeType', 'SDTDisplayText', 'eLEXTYPE_PRIVATE10',
    'SVSFParseAutodetect', 'SAFTGSM610_11kHzMono', 'DISPID_SVResume',
    'ISpeechAudioStatus', 'SDTLexicalForm', 'SPWT_LEXICAL',
    'DISPID_SpeechPhraseElement', 'SPRECORESULTTIMES',
    'Speech_Max_Word_Length', 'eLEXTYPE_PRIVATE12',
    'DISPID_SRCRetainedAudio', 'DISPID_SRGState',
    'DISPID_SPRules_NewEnum', 'SpeechPropertyResourceUsage',
    'SAFT11kHz8BitStereo', 'SP_VISEME_5', 'DISPID_SRCEPhraseStart',
    'DISPID_SVSyncronousSpeakTimeout', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SMSAMMHandle',
    'SPDKL_DefaultLocation', 'ISpeechRecoResultDispatch',
    'DISPID_SVSCurrentStreamNumber', 'SPSLMA', 'SPEI_SOUND_END',
    'DISPID_SRGDictationLoad', 'SpeechAudioState',
    'eLEXTYPE_RESERVED8', 'DISPID_SGRSTNextState', 'SPPHRASERULE',
    'SPCS_ENABLED', 'SpeechCategoryRecognizers',
    'DISPID_SDKSetBinaryValue', 'SPPS_LMA', 'SpInProcRecoContext',
    'UINT_PTR', 'ISpeechPhraseRules', 'SPEI_WORD_BOUNDARY',
    'ISpLexicon', 'DISPID_SPIEngineId', 'SPBO_AHEAD', 'SPLEXICONTYPE',
    'STCInprocServer', 'SSTTWildcard', 'DISPID_SGRSTPropertyName',
    'SpeechRetainedAudioOptions', 'DISPID_SRCEStartStream',
    'SRTStandard', 'SPDKL_CurrentUser',
    'DISPID_SpeechPhraseAlternates', 'SECFIgnoreWidth',
    'DISPIDSPTSI_SelectionOffset', 'SWPUnknownWordPronounceable',
    'SVEAllEvents', 'DISPID_SAFSetWaveFormatEx',
    'ISpPhoneticAlphabetSelection', 'SpSharedRecognizer',
    'DISPID_SRGSetTextSelection', 'eLEXTYPE_LETTERTOSOUND',
    'SpeechPropertyAdaptationOn', 'SVP_9', 'SpeechGrammarTagWildcard',
    'SGDSActiveUserDelimited', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SPAsItem', 'DISPID_SRCRecognizer', 'SAFT22kHz8BitMono',
    'ISpeechVoiceStatus', 'ISpObjectWithToken', 'SP_VISEME_16',
    'DISPID_SPPFirstElement', 'ISpProperties',
    'DISPID_SPRuleChildren', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SGRSTsCount', 'STSF_CommonAppData', 'SP_VISEME_4',
    'LONG_PTR', 'DISPID_SVGetVoices', 'DISPID_SpeechPhraseInfo',
    'DISPID_SPEsItem', 'DISPID_SLWType', 'SPAUDIOSTATE',
    'DISPID_SRAudioInputStream', 'SPSHORTCUTPAIR', 'DISPID_SVEWord',
    'SpSharedRecoContext', 'DISPID_SpeechPhraseProperty',
    'ISpRecoResult', 'SVSFParseMask', 'SPEI_SR_BOOKMARK',
    'ISpSerializeState', 'SAFT32kHz8BitStereo', 'DISPID_SMSGetData',
    'SPRECOGNIZERSTATUS', 'eLEXTYPE_RESERVED7', 'SpVoice',
    'DISPID_SBSRead', 'SpeechAudioFormatGUIDText',
    'DISPID_SDKDeleteKey', 'ISpRecoCategory', 'SpeechRecognizerState',
    'DISPID_SpeechGrammarRule', 'SpeechTokenKeyUI',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRCResume',
    'DISPID_SRRSpeakAudio', 'SpeechPropertyResponseSpeed',
    'eLEXTYPE_PRIVATE5', 'SpeechMicTraining', 'ISpeechPhraseRule',
    'SP_VISEME_1', 'DISPID_SPEAudioTimeOffset', 'DISPID_SRRTLength',
    'DISPID_SPEs_NewEnum', '_RemotableHandle', 'ISpeechRecoResult2',
    'SAFTGSM610_22kHzMono', 'SGDSInactive', 'DISPID_SPPValue',
    'SAFTCCITT_uLaw_44kHzMono', 'SPPHRASEREPLACEMENT',
    'SVEStartInputStream', 'SSTTTextBuffer', 'SPSInterjection',
    'SPEI_HYPOTHESIS', 'DISPID_SpeechPhoneConverter', 'SPVPRI_OVER',
    'SPEI_RECOGNITION', 'SRAInterpreter', 'SPSHT_Unknown', 'ISpAudio',
    'SVP_17', 'SPPS_Function', 'DISPID_SpeechGrammarRules',
    'ISpeechRecognizerStatus', 'DISPID_SASCurrentDevicePosition',
    'SPRST_ACTIVE', 'SpeechBookmarkOptions', 'SRERecognition',
    'DISPID_SpeechGrammarRuleState', 'SPPS_RESERVED2',
    'DISPID_SDKGetBinaryValue', 'DISPID_SpeechMMSysAudio',
    'DISPID_SPELexicalForm', 'DISPID_SLPsItem', 'SP_VISEME_3',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SRIsShared', 'SVP_20',
    'DISPID_SGRsItem', 'SpeechDisplayAttributes',
    'DISPID_SCSBaseStream', 'SAFT24kHz8BitStereo', 'SP_VISEME_13',
    'tagSPPROPERTYINFO', 'DISPID_SBSSeek', 'eLEXTYPE_PRIVATE16',
    'DISPID_SVSRunningState', 'DISPID_SFSOpen', 'ISpRecoContext',
    'DISPID_SRGCmdLoadFromMemory', 'SGSExclusive',
    'DISPID_SVEventInterests', 'SpCustomStream',
    'DISPID_SRRRecoContext', 'SPPS_RESERVED3', 'SVSFParseSapi',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SVSLastBookmark',
    'SAFTGSM610_44kHzMono', 'SPWORD', 'DISPID_SRSAudioStatus',
    'eLEXTYPE_PRIVATE15', 'SAFT32kHz16BitMono', 'DISPID_SGRSTWeight',
    'SPPS_Unknown', 'SVEBookmark', 'eLEXTYPE_RESERVED6',
    'DISPID_SVEBookmark', 'SPRECOSTATE', 'SP_VISEME_2',
    'DISPID_SPEAudioSizeBytes', 'ISpPhrase', 'DISPID_SOTsItem',
    'SAFT12kHz16BitMono', 'SP_VISEME_10', 'SDKLLocalMachine',
    'eLEXTYPE_VENDORLEXICON', 'SFTInput', 'SVP_21', 'SRCS_Enabled',
    'SDTAll', 'SpeechRuleAttributes', 'SPDKL_LocalMachine',
    'SpeechEngineConfidence', 'SREHypothesis', 'eLEXTYPE_RESERVED10',
    'DISPID_SPRsItem', 'SPPS_Verb', 'SPPS_Modifier',
    'DISPID_SVAudioOutput', 'SPGS_DISABLED', 'DISPID_SGRAttributes',
    'DISPID_SPPId', 'ISpeechAudio', 'ISpeechWaveFormatEx',
    'ISpeechLexiconPronunciations', 'SpMMAudioIn', 'SPAUDIOOPTIONS',
    'DISPID_SASCurrentSeekPosition', 'SECFNoSpecialChars',
    'DISPID_SpeechLexicon', 'SPEI_RESERVED5', 'SGSEnabled',
    'SDTProperty', 'SPEI_ACTIVE_CATEGORY_CHANGED', 'SPEI_UNDEFINED',
    'SREBookmark', 'SPAUDIOBUFFERINFO', 'DISPID_SRCSetAdaptationData',
    'SPEI_PHRASE_START', 'ISpeechResourceLoader',
    'SpeechInterference', 'DISPID_SOTIsUISupported',
    'eWORDTYPE_DELETED', 'SPPS_SuppressWord',
    'DISPID_SVEEnginePrivate', 'eLEXTYPE_PRIVATE8',
    'eLEXTYPE_RESERVED4', 'SVP_10', 'DISPID_SVESentenceBoundary',
    'DISPID_SRCBookmark', 'SBOPause', 'SPSEMANTICERRORINFO',
    '_ISpeechVoiceEvents', 'SAFT12kHz8BitMono',
    'SpeechTokenIdUserLexicon', 'SpeechGrammarTagDictation',
    'DISPID_SLRemovePronunciation', 'DISPID_SGRId',
    'SGRSTTTextBuffer', 'SpObjectToken', 'ISpeechFileStream',
    'DISPID_SRRGetXMLResult', 'SPEI_REQUEST_UI', 'DISPID_SAStatus',
    'IEnumString', 'SREStreamEnd', 'ISpeechLexicon',
    'DISPID_SPRDisplayAttributes', 'DISPID_SpeechPhraseRules',
    'DISPID_SLPType', 'SPPS_Interjection',
    'SpPhoneticAlphabetConverter', 'ISpeechCustomStream',
    'WAVEFORMATEX', 'DISPID_SLGetPronunciations', 'DISPID_SPAsCount',
    'SSFMCreateForWrite', 'DISPID_SPEPronunciation',
    'SAFTADPCM_22kHzMono', 'SVSFVoiceMask',
    'SpeechSpecialTransitionType', 'SRCS_Disabled', 'ISpEventSource',
    'DISPID_SABIBufferSize', 'SpWaveFormatEx',
    'SpStreamFormatConverter', 'SAFT11kHz16BitMono',
    'DISPID_SOTCategory', 'DISPID_SRRAudioFormat', 'SPWF_INPUT',
    'SPTEXTSELECTIONINFO', 'SLODynamic', 'SPGRAMMARSTATE',
    'SPLOADOPTIONS', 'STSF_LocalAppData', 'SVF_Emphasis',
    'SPRST_NUM_STATES', 'DISPID_SLPsCount', 'SRSActive',
    'DISPID_SpeechXMLRecoResult', 'SRARoot',
    'SpeechEmulationCompareFlags', 'SPFM_CREATE',
    'DISPID_SDKGetStringValue', 'eLEXTYPE_PRIVATE19', 'SVSFNLPMask',
    'SAFTGSM610_8kHzMono', 'SRAONone',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SGRSAddSpecialTransition', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SPRs_NewEnum', 'DISPID_SRCCreateGrammar',
    'DISPID_SPPsItem', 'DISPID_SpeechLexiconProns',
    'SPSEMANTICFORMAT', 'DISPID_SVSpeakStream', 'SPCT_SLEEP',
    'DISPID_SRProfile', 'SPCATEGORYTYPE', 'SVEWordBoundary',
    'SECFIgnoreCase', 'DISPID_SOTDataKey',
    'DISPID_SABufferNotifySize',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SSFMCreate',
    'SREInterference', 'SVP_15', 'SAFT44kHz8BitStereo',
    'SVF_Stressed', 'eLEXTYPE_USER_SHORTCUT', 'SAFTADPCM_44kHzStereo',
    'SpCompressedLexicon', 'SPSModifier', 'SRAImport',
    'DISPID_SGRSTRule', 'SPEI_RECO_STATE_CHANGE',
    'ISpStreamFormatConverter', 'SITooQuiet',
    'DISPID_SGRSTransitions', 'SPWAVEFORMATTYPE', 'SDKLCurrentUser',
    'ISpeechPhraseReplacement', 'DISPID_SVEPhoneme',
    'SAFT8kHz8BitStereo', 'DISPID_SOTGetStorageFileName',
    'DISPID_SRRAudio', 'SAFT24kHz16BitMono', 'SPEI_START_SR_STREAM',
    'SPRS_INACTIVE', 'SPAS_CLOSED', 'SPEI_RECO_OTHER_CONTEXT',
    'ISpNotifySource', 'DISPID_SPRFirstElement',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SpeechRecoResult2',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SOTDisplayUI',
    'ISpeechRecoResult', 'DISPID_SAFGetWaveFormatEx', 'SRERequestUI',
    'SP_VISEME_7', 'SPWORDPRONUNCIATIONLIST',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPPARTOFSPEECH',
    'SDTPronunciation', 'SPINTERFERENCE', 'SP_VISEME_15',
    'SVSFlagsAsync', 'DISPID_SVEViseme', 'SVPOver',
    'SpeechRecoContextState', 'DISPID_SDKSetLongValue',
    'ISpPhoneticAlphabetConverter', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SRCEAdaptation', 'SpeechRunState', 'DISPID_SPRuleName',
    'DISPID_SWFEAvgBytesPerSec', 'eLEXTYPE_PRIVATE4', 'SpFileStream',
    'SPWORDTYPE', 'SPVPRI_NORMAL', 'DISPID_SVRate',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPDKL_CurrentConfig',
    'SREPropertyNumChange', 'DISPID_SpeechLexiconPronunciation',
    'SPXRO_Alternates_SML', 'Speech_StreamPos_RealTime',
    'DISPID_SpeechCustomStream',
    'DISPID_SLAddPronunciationByPhoneIds', 'SRTEmulated',
    'SPXMLRESULTOPTIONS', 'SITooSlow',
    'DISPID_SRSCurrentStreamPosition', 'SpeechPartOfSpeech',
    'SpeechDiscardType', 'SREFalseRecognition', 'SGLexical', 'SVP_1',
    'DISPID_SOTGetAttribute', 'SPSHT_OTHER', 'SVEVoiceChange',
    'SVP_19', 'SAFTCCITT_uLaw_11kHzMono', 'SDTAudio',
    'SPGS_EXCLUSIVE', 'DISPID_SWFEFormatTag', 'SGRSTTEpsilon',
    'DISPID_SPISaveToMemory', 'DISPID_SRCEFalseRecognition',
    'SPEI_MAX_TTS', 'SpeechCategoryPhoneConverters',
    'SVSFNLPSpeakPunc', 'DISPID_SVGetProfiles',
    'SpeechAudioFormatGUIDWave', 'SVSFDefault', 'ISpeechGrammarRules',
    'DISPID_SAFGuid', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SLWs_NewEnum', 'eLEXTYPE_PRIVATE17',
    'SSSPTRelativeToStart', 'SAFT16kHz16BitMono',
    'DISPID_SpeechPhraseBuilder', 'SVSFIsFilename', 'SVP_8',
    'ISpStream', 'SPINTERFERENCE_TOOSLOW', 'DISPID_SWFEBitsPerSample',
    'SpeechLexiconType', 'SPPS_RESERVED4',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SRCESoundStart',
    'SpeechTokenKeyAttributes', 'SAFTADPCM_8kHzMono',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SpeechRecognizer',
    'SVEAudioLevel', 'eLEXTYPE_PRIVATE20',
    'DISPID_SRGCmdLoadFromFile', 'SpLexicon', 'SAFT22kHz16BitStereo',
    'SECFDefault', 'SVP_13', 'DISPID_SGRSTText', 'SAFT44kHz8BitMono',
    'DISPID_SOTSetId', 'SPSSuppressWord', 'SAFT22kHz16BitMono',
    'DISPID_SLPLangId', 'DISPID_SASFreeBufferSpace', 'SPCS_DISABLED',
    'SAFT11kHz16BitStereo', 'DISPID_SDKSetStringValue',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRSetPropertyString', 'SITooFast', 'ISpShortcut',
    'DISPID_SVSVisemeId', 'SpeechWordType',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SVDisplayUI',
    'DISPID_SOTGetDescription', 'SpeechRecoEvents',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPSMF_UPS', 'SVSFIsXML',
    'DISPID_SRRSaveToMemory', 'SVSFUnusedFlags', 'SPSERIALIZEDPHRASE',
    '_ISpeechRecoContextEvents', 'SPEVENTENUM', 'SPLO_STATIC',
    'SP_VISEME_19', 'SAFTText', 'ISequentialStream',
    'ISpeechRecoContext', 'ISpeechPhoneConverter', 'SPEI_VISEME',
    'DISPID_SPPsCount', 'SPEI_END_INPUT_STREAM',
    'DISPID_SRGDictationUnload', 'DISPID_SpeechVoiceStatus',
    'DISPID_SPEDisplayText', 'SVP_18', 'DISPID_SPIAudioSizeTime',
    'SLTApp', 'SAFT48kHz8BitStereo', 'SpeechDataKeyLocation',
    'DISPID_SpeechAudioStatus', 'SPBOOKMARKOPTIONS',
    'DISPID_SWFEExtraData', 'SREAdaptation', 'DISPID_SGRName',
    'DISPID_SRCERequestUI', 'DISPIDSPTSI_ActiveLength',
    'SPADAPTATIONRELEVANCE', 'eLEXTYPE_PRIVATE18',
    'SPEI_PROPERTY_STRING_CHANGE', 'SpeechRecognitionType',
    'ISpeechLexiconWord', 'DISPID_SLGenerationId',
    'SPEI_SENTENCE_BOUNDARY', 'SRERecoOtherContext', 'SVP_7',
    'DISPID_SRSClsidEngine', 'ISpeechPhraseProperty',
    'DISPID_SVPriority', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SPRuleParent', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'eLEXTYPE_PRIVATE3', 'SPAR_Unknown', 'SVSFPurgeBeforeSpeak',
    'DISPID_SRGSetWordSequenceData', 'ISpRecognizer',
    'SpeechCategoryAppLexicons', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SDKLCurrentConfig', 'SPPS_Noncontent', 'SRAORetainAudio',
    ...
    'DISPID_SABufferInfo', 'SDA_Two_Trailing_Spaces',
    'DISPID_SVSInputWordLength', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SPIProperties', 'SpAudioFormat',
    'DISPID_SRCEInterference', 'DISPID_SRCRequestedUIType',
    'DISPID_SPIEnginePrivateData', 'DISPID_SLWPronunciations',
    'SPFM_OPEN_READWRITE', 'SREPropertyStringChange',
    'DISPID_SLPs_NewEnum', 'DISPID_SRGetFormat',
    'SPINTERFERENCE_TOOLOUD', 'SREStreamStart',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SPPName',
    'SRSInactive', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SPEI_TTS_BOOKMARK', 'SP_VISEME_8', 'DISPID_SVPause',
    'SpeechTokenValueCLSID', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPBINARYGRAMMAR', 'SSTTDictation', 'DISPID_SFSClose',
    'DISPID_SASetState', 'SpeechCategoryRecoProfiles',
    'DISPID_SRRTimes', 'ISpeechPhraseElement', 'SPSHORTCUTPAIRLIST',
    'SFTSREngine', 'SAFTExtendedAudioFormat', 'SVPAlert',
    'DISPID_SPCPhoneToId', 'SGRSTTRule', 'eLEXTYPE_PRIVATE7',
    'DISPID_SGRsAdd', 'SpPhoneConverter', 'DISPID_SWFESamplesPerSec',
    'DISPID_SRRSetTextFeedback', 'SPRST_INACTIVE',
    'DISPID_SpeechObjectToken', 'ISpeechDataKey', 'SRTAutopause',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SRGDictationSetState', 'SPWT_DISPLAY',
    'eLEXTYPE_PRIVATE1', 'DISPID_SVStatus', 'SPEI_MIN_SR',
    'DISPID_SPIReplacements', 'DISPID_SVSkip',
    'DISPID_SRCEEnginePrivate', 'SPAR_High',
    'DISPID_SpeechRecoResult', 'SREAudioLevel', 'SRATopLevel',
    'DISPID_SVVolume', 'SVP_3', 'DISPID_SPEAudioSizeTime',
    'DISPID_SPRulesItem', 'DISPID_SRRTStreamTime',
    'DISPIDSPTSI_SelectionLength', 'SAFT22kHz8BitStereo',
    'DISPID_SPARecoResult', 'SpeechWordPronounceable',
    'DISPID_SOTCreateInstance', 'DISPID_SOTCGetDataKey',
    'DISPID_SPERequiredConfidence', 'DISPID_SOTId',
    'DISPID_SRCEEndStream', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'Speech_StreamPos_Asap', 'ISpeechGrammarRuleState',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SPERetainedSizeBytes',
    'SDTReplacement', 'ISpeechPhraseInfo', '__MIDL_IWinTypes_0009',
    'DISPID_SPPNumberOfElements', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SLWsItem', 'SPDATAKEYLOCATION', 'SP_VISEME_18',
    'SPVOICESTATUS', 'DISPID_SRCESoundEnd', 'SVP_0', 'SRSEIsSpeaking',
    'SPWT_PRONUNCIATION', 'SPCONTEXTSTATE', 'DISPID_SPPConfidence',
    'SPWF_SRENGINE', 'ISpNotifySink', 'ISpXMLRecoResult',
    'SECFIgnoreKanaType', 'SPCT_COMMAND', 'ISpeechAudioFormat',
    'DISPID_SpeechPhraseElements', 'SRESoundStart',
    'DISPID_SpeechLexiconWords', 'SGRSTTWildcard',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPRulesCount', 'ISpeechBaseStream',
    'SpeechRegistryUserRoot', 'DISPID_SRRTTickCount',
    'SECHighConfidence', 'SpInprocRecognizer', 'SPPS_RESERVED1',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SVSInputSentencePosition',
    'SPPHRASEPROPERTY', 'DISPID_SPEActualConfidence',
    'SPCT_DICTATION', 'SPGRAMMARWORDTYPE', 'DISPID_SDKDeleteValue',
    'DISPID_SLAddPronunciation', 'SWPKnownWordPronounceable',
    'STCLocalServer', 'SAFTADPCM_8kHzStereo', 'SVF_None',
    'DISPID_SBSFormat', 'SpeechRecoProfileProperties',
    'SpNullPhoneConverter', 'SRADefaultToActive', 'SPSFunction',
    'SPEI_PHONEME', 'SWPUnknownWordUnpronounceable',
    'STSF_FlagCreate', 'DISPID_SVSpeak', 'SRADynamic',
    'ISpObjectTokenCategory', 'DISPID_SRState',
    'DISPID_SRCreateRecoContext', 'SAFTADPCM_11kHzStereo',
    'DISPID_SGRSTPropertyId', 'SpeechPropertyHighConfidenceThreshold',
    'SPAO_RETAIN_AUDIO', 'SPAR_Low', 'SDKLDefaultLocation',
    'DISPID_SRAudioInput', 'SPRECOCONTEXTSTATUS',
    'SPEI_END_SR_STREAM', 'SpeechGrammarState', 'DISPID_SRGReset',
    'SPCT_SUB_DICTATION', 'DISPID_SVEStreamStart', 'DISPID_SGRClear',
    'SPEI_RESERVED2', 'SPWORDPRONUNCIATION',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SVEStreamEnd',
    'SPEI_VOICE_CHANGE', 'DISPID_SpeechPhraseProperties',
    'DISPID_SPIRule', 'eLEXTYPE_MORPHOLOGY', 'SAFT24kHz16BitStereo',
    'SAFTCCITT_ALaw_11kHzMono', 'SVPNormal', 'SPBO_NONE',
    'DISPID_SOTCId', 'SINoSignal', 'DISPID_SpeechRecoContextEvents',
    'SREStateChange', 'SpeechEngineProperties', 'SAFT12kHz8BitStereo',
    'eLEXTYPE_PRIVATE11', 'DISPID_SPIStartTime',
    'ISpeechLexiconWords', 'DISPID_SpeechRecoContext',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SRAExport', 'SPSUnknown',
    'SGSDisabled', 'DISPID_SPAPhraseInfo', 'DISPID_SpeechPhraseRule',
    'SPSHT_NotOverriden', 'SPPS_Noun',
    'DISPID_SPANumberOfElementsInResult', 'SPAS_RUN',
    ...
    'SAFT48kHz8BitMono', 'ISpStreamFormat', 'SP_VISEME_17',
    'SVESentenceBoundary', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRGRecoContext', 'DISPID_SRGetPropertyString',
    'ISpRecoGrammar2', 'DISPID_SLGetWords',
    'DISPID_SLRemovePronunciationByPhoneIds', 'ISpeechMMSysAudio',
    'DISPID_SWFEBlockAlign', 'eLEXTYPE_PRIVATE13', 'SPEI_RESERVED6',
    'DISPID_SRGetPropertyNumber', 'SECLowConfidence',
    'DISPID_SRSSupportedLanguages', 'SREPhraseStart', 'SREPrivate',
    'ISpeechTextSelectionInformation', 'IStream', 'SpMMAudioEnum',
    'DISPID_SPRsCount', 'SpeechAudioProperties',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SRGCmdSetRuleIdState', 'SASClosed',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SRCEAudioLevel',
    'DISPID_SPEAudioStreamOffset', 'SPAS_PAUSE',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SREmulateRecognition',
    'ISpRecoContext2', 'SDA_No_Trailing_Space', 'SVEEndInputStream',
    'SPVPRI_ALERT', 'SPVPRIORITY', 'DISPID_SPIGrammarId',
    'SpTextSelectionInformation', 'DISPID_SPRuleEngineConfidence',
    'SAFTCCITT_ALaw_44kHzStereo', 'eLEXTYPE_RESERVED9',
    'SVSFIsNotXML', 'SpeechGrammarWordType', 'SPRULE', 'SPAR_Medium',
    'SPEI_RESERVED1', 'SPEVENTSOURCEINFO', 'SREAllEvents',
    'DISPID_SGRSTsItem', 'SAFTNoAssignedFormat', 'SGDisplay',
    'DISPID_SVSInputWordPosition', 'DISPIDSPTSI', 'SPAUDIOSTATUS',
    'SAFT44kHz16BitStereo', 'DISPID_SPEsCount',
    'DISPID_SRSetPropertyNumber', 'SPFM_CREATE_ALWAYS', 'SPAO_NONE',
    'SP_VISEME_11', 'SPPS_NotOverriden', 'Speech_Default_Weight',
    'DISPID_SRGIsPronounceable', 'SPVISEMES', 'DISPID_SLWsCount',
    'DISPID_SMSSetData', 'DISPID_SASState', 'DISPID_SPRuleConfidence',
    'SPRS_ACTIVE', 'SDTAlternates', 'DISPID_SRGetRecognizers',
    'SPPROPERTYINFO', 'SPFM_NUM_MODES', 'DISPID_SGRInitialState',
    'DISPID_SVWaitUntilDone', 'SPXRO_SML', 'SITooLoud',
    'DISPID_SRCERecognitionForOtherContext', 'SVP_5',
    'SSFMOpenReadWrite', 'SDA_Consume_Leading_Spaces',
    'DISPID_SVGetAudioOutputs', 'SPEVENT', 'IInternetSecurityManager',
    'DISPID_SRGCommit', 'DISPID_SPIElements', 'ISpRecognizer3',
    'SRSEDone', 'SP_VISEME_0', 'DISPID_SGRsCommit',
    'DISPID_SVGetAudioInputs', 'DISPID_SPCIdToPhone',
    'DISPID_SLGetGenerationChange', 'SPEI_SOUND_START',
    'SPCT_SUB_COMMAND'
]
